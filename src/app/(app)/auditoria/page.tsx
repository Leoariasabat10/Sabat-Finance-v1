...
export default async function Page() {
  ...
  return (
    <div className="animate-fade-up">
      ...
      {eventos.length === 0 ? (
        <EmptyState
          icon={<History className="h-10 w-10 text-faint" />}
          ...
          <CardContent className="p-0">
            <StaggerList className="flex flex-col divide-y divide-[color:var(--border)]">
              {eventos.map((e) => {
                ...
                return (
                  <StaggerItem key={String(e.id)}>
                    <div className="flex flex-wrap items-center justify-between gap-3 px-[18px] py-3 transition-colors duration-premium hover:bg-hover-bg">
